...
public class Main {
     ...
     * @param structure structure of the robots
     */
    public Main(int[][] adjacencyMatrix, int[] structure) {
     ...
     */
    public void setNewStructure(int[][] adjacencyMatrix, int[] structure) {
        this.adjacencyMatrix = adjacencyMatrix;
        this.structure = structure;
    }
